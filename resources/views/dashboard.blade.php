                    ...
                    @else
                        <form method="POST" action="{{ route('telegram.unlink', $user) }}" class="mr-1">
                            ...
                            <div class="flex items-center mt-4">
                                <img class="w-12 h-12" src="{{ $user->telegramUser->photo_url }}" alt="{{ '@'.$user->telegramUser->username }}">
                                <a class="underline text-sm text-grey-600 hover:text-grey-900 ml-3" href="{{ 'https://t.me/@'.$user->telegramUser->username }}">
